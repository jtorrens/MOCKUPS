...
const retiredPaths = [
  ...
  "src/Mockups.Persistence.Sqlite/SqliteProjectEngine.ComponentClassDefaults.cs",
  "src/Mockups.Persistence.Sqlite/SqliteProjectEngine.ComponentClassNormalization.cs",
