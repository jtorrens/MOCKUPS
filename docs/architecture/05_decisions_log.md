...
- Continue extracting the remaining domain field handlers from `RecordEditor`, especially App token root composition, Module Theme token groups, and any remaining top-level editor composition glue.
