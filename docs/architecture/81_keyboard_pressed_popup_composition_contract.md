...
- a connector joining the head to the pressed key;
...
second key shadow or duplicated lower glyph remains.
...
Automated tests verify centered width, continuous extent through the base key,
