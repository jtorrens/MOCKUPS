...
internal static class EmbeddedComponentSlotCatalog
{
    ...
    [
        ...
        new("component.listItem.components.avatar.component", "avatar", "Avatar", "component.avatar", ["listItem", "components", "avatar", "componentSlot"]),
        new("component.listItem.components.label.component", "label", "Label", "component.label", ["listItem", "components", "label", "componentSlot"]),
        new("component.listItem.components.iconRow.component", "iconRow", "Icon Row", "component.iconRow", ["listItem", "components", "iconRow", "componentSlot"]),
        new("component.listItem.states.normal.surface", "surface", "Normal surface", "component.surface", ["listItem", "states", "normal", "surfaceSlot"]),
        new("component.listItem.states.pressed.surface", "surface", "Pressed surface", "component.surface", ["listItem", "states", "pressed", "surfaceSlot"]),
