...
internal static class ComponentClassFieldCatalog
{
    ...
    private static readonly Dictionary<string, ComponentClassFieldDescriptor> Fields = new(StringComparer.Ordinal)
    {
        ...
        ["component.label.backgroundAlpha"] = new("component.label.backgroundAlpha", "Background alpha", ValueKind.Alpha, ["label", "backgroundAlpha"], "1"),
        ["component.label.borderAlpha"] = new("component.label.borderAlpha", "Border alpha", ValueKind.Alpha, ["label", "borderAlpha"], "1"),
        ["component.label.reliefAlpha"] = new("component.label.reliefAlpha", "Relief alpha", ValueKind.Alpha, ["label", "reliefAlpha"], "1"),
