...
internal static class RecordClassFieldCatalog
{
    private static readonly Dictionary<string, RecordClassFieldDescriptor> Fields = new(StringComparer.Ordinal)
    {
        ...
        ["shot.durationFrames"] = new("shot.durationFrames", "Duration Frames", ValueKind.Integer),
        ...
        ["renderPreset.width"] = new("renderPreset.width", "Width", ValueKind.Integer),
        ["renderPreset.height"] = new("renderPreset.height", "Height", ValueKind.Integer),
        ["renderPreset.fps"] = new("renderPreset.fps", "FPS", ValueKind.Integer),
        ...
        ["device.metrics.scaleToPixels"] = new("device.metrics.scaleToPixels", "Scale to pixels", ValueKind.Integer),
        ["device.metrics.pixelRatio"] = new("device.metrics.pixelRatio", "Pixel ratio", ValueKind.Integer),
        ["device.metrics.defaultScreenScale"] = new("device.metrics.defaultScreenScale", "Default screen scale", ValueKind.Integer),
        ...
        ["navigationBar.layout.strokeWidth"] = new("navigationBar.layout.strokeWidth", "Stroke width", ValueKind.StringSingleLine),
