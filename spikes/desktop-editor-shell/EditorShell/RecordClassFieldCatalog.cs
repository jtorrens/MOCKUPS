...
internal static class RecordClassFieldCatalog
{
    private static readonly Dictionary<string, RecordClassFieldDescriptor> Fields = new(StringComparer.Ordinal)
    {
        ...
        ["theme.shadows.avatar.color"] = new("theme.shadows.avatar.color", "Avatar color", ValueKind.PaletteColorToken),
        ["theme.shadows.avatar.alpha"] = new("theme.shadows.avatar.alpha", "Avatar alpha", ValueKind.Alpha),
        ["theme.shadows.avatar.offsetX"] = new("theme.shadows.avatar.offsetX", "Avatar offset X", ValueKind.Decimal),
        ["theme.shadows.avatar.offsetY"] = new("theme.shadows.avatar.offsetY", "Avatar offset Y", ValueKind.Decimal),
        ["theme.shadows.avatar.blur"] = new("theme.shadows.avatar.blur", "Avatar blur", ValueKind.Decimal),
        ["theme.shadows.elevated.color"] = new("theme.shadows.elevated.color", "Elevated color", ValueKind.PaletteColorToken),
        ["theme.shadows.elevated.alpha"] = new("theme.shadows.elevated.alpha", "Elevated alpha", ValueKind.Alpha),
        ["theme.shadows.elevated.offsetX"] = new("theme.shadows.elevated.offsetX", "Elevated offset X", ValueKind.Decimal),
        ["theme.shadows.elevated.offsetY"] = new("theme.shadows.elevated.offsetY", "Elevated offset Y", ValueKind.Decimal),
        ["theme.shadows.elevated.blur"] = new("theme.shadows.elevated.blur", "Elevated blur", ValueKind.Decimal),
