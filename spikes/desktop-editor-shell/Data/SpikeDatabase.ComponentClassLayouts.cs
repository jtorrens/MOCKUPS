            ...
            ,
            {
              ...
              "groups": [
                { "id": "keys", "label": "Keys", "order": 10, "visible": true, "collapsible": true, "exclusive": true, "defaultOpen": true, "fields": [
                  ...
                  { "id": "component.keyboard.typography", "order": 90, "visible": true },
                  { "id": "component.keyboard.keyPadding", "order": 100, "visible": true },
                  { "id": "component.keyboard.keyCornerRadiusToken", "order": 110, "visible": true },
                  { "id": "component.keyboard.keyBorderWidth", "order": 120, "visible": true },
                  { "id": "component.keyboard.keyBorderColorToken", "order": 130, "visible": true },
                  { "id": "component.keyboard.keyShadowEnabled", "order": 140, "visible": true },
                  { "id": "component.keyboard.pressedEffect", "order": 150, "visible": true },
                  { "id": "component.keyboard.specialKeyTextScale", "order": 160, "visible": true },
                  { "id": "component.keyboard.emojiScale", "order": 170, "visible": true }
                ] },
