...
internal sealed partial class SpikeDatabase
{
                ...
                new JsonObject
                {
                    ...
                    ["itemActions"] = new JsonArray
                    {
                        new JsonObject
                        {
                            ...
                            ["startAfterItemNumberKeys"] = new JsonArray { "delayAfterPreviousFrames", "writeOnDurationFrames" },
    ...
    private static JsonArray ConversationPreviewMessageFields()
    {
        var fields = new JsonArray
        {
            ...
            new JsonObject { ["id"] = "writeOn", ["label"] = "Write-on frames", ["jsonKey"] = "writeOnDurationFrames", ["kind"] = "number", ["defaultValue"] = "0", ["minimum"] = 0, ["maximum"] = 100000, ["increment"] = 1, ["unit"] = "frames" },
