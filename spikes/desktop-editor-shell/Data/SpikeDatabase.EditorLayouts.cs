    ...
    private static void NormalizeEditorLayouts(SqliteConnection connection)
    {
        ...
        if (!string.IsNullOrWhiteSpace(audioLayout)
            && (audioLayout.Contains("component.audio.waveformBarWidth", StringComparison.Ordinal)
                ...
                || audioLayout.Contains("component.audio.badge.showBadge", StringComparison.Ordinal)
                || audioLayout.Contains("component.audio.badge.iconToken", StringComparison.Ordinal)
                || !audioLayout.Contains("component.audio.badge.editor", StringComparison.Ordinal)
                || !audioLayout.Contains("component.audio.badge.placement", StringComparison.Ordinal)
