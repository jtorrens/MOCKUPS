    ...
    private static readonly IReadOnlyDictionary<ValueKind, Func<DictionaryControlRequest, IDictionaryValueControl>> Controls =
        new Dictionary<ValueKind, Func<DictionaryControlRequest, IDictionaryValueControl>>
        {
            ...
            [ValueKind.TypographySystemStyle] = (request) => new DictionaryTypographyStyleControl(
                ...
                request.Services.ShowThemeTokenPicker,
                "theme.system"),
            [ValueKind.Alpha] = (request) => new DictionaryAlphaControl(request.Definition, request.Value),
            ...
            [ValueKind.HueDegrees] = (request) => new HueDegreesControl(request.Definition, request.Value),
            ...
            [ValueKind.JsonFilePath] = (request) => new DictionaryPathControl(
                request.Definition,
                request.Value,
                request.Services.BrowsePath),
            ...
            [ValueKind.MediaDirectoryPath] = (request) => new DictionaryPathControl(
                ...
                request.Value,
                request.Services.BrowsePath),
            [ValueKind.VideoFilePath] = (request) => new DictionaryPathControl(
                request.Definition,
                request.Value,
                request.Services.BrowsePath),
