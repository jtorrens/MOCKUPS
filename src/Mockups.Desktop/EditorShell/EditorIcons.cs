...
internal static class EditorIcons
{
    ...
    public static string ForTreeNode(ProjectTreeNodeKind kind)
    {
        return kind switch
        {
            ...
            ProjectTreeNodeKind.ProductionPaletteColor => Color,
            ProjectTreeNodeKind.IconTheme => Icon,
            ProjectTreeNodeKind.ComponentClass => Component,
