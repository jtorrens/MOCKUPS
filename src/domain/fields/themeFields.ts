...
const GROUPS = {
  ...
  spacing: { id: "spacing", label: "Spacing" },
...
export const THEME_FIELDS = defineFields({
  ...
  spacingNone: {
    id: "theme.spacing.none",
    kind: "integer",
    defaultValue: 0,
    ui: {
      label: "None",
      group: GROUPS.spacing,
      min: 0,
      step: 1,
    },
  },
...
export const THEME_TOKEN_BINDINGS = [
  ...
  { outputPath: ["spacing", "none"], field: THEME_FIELDS.spacingNone },
  { outputPath: ["spacing", "xs"], field: THEME_FIELDS.spacingXs },
  { outputPath: ["spacing", "s"], field: THEME_FIELDS.spacingS },
  { outputPath: ["spacing", "m"], field: THEME_FIELDS.spacingM },
  { outputPath: ["spacing", "l"], field: THEME_FIELDS.spacingL },
  { outputPath: ["spacing", "xl"], field: THEME_FIELDS.spacingXl },
  { outputPath: ["spacing", "xxl"], field: THEME_FIELDS.spacingXxl },
