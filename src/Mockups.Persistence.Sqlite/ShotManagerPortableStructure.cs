...
public sealed record ShotManagerPortableStructureEntry(
    string EntryId,
    string RelativePath);

public sealed record ShotManagerPortableOutputContract(
    string EntryId,
    string RelativeDirectory,
    string FileNamePrefix,
    int VersionPadding);

public sealed record ShotManagerPortableStructure(
    int SchemaVersion,
