...
try {
  ...
  assert(
    Number(database.pragma("user_version", { simple: true })) === 25,
    "SQLite schema version must be 25",
  );
  ...
  console.log("✓ screen_instances references, module_instances content/behavior/animation, component classes, production font families, palette-normalized colors, and screen durations exist in schema v25");
