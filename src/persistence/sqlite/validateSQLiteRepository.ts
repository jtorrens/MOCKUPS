...
try {
  ...
  assert(
    Number(database.pragma("user_version", { simple: true })) === 13,
    "SQLite schema version must be 13",
  );
  ...
  console.log("✓ screen_instances references and module_instances content/behavior/animation columns exist in schema v13");
