...
internal sealed class VisualInstanceConflictWindow : Window
{
    public VisualInstanceConflictWindow()
    {
        Title = "MOCKUPS";
        Width = 520;
        Height = 240;
        ...
        Content = new StackPanel
        {
            ...
            Children =
            {
                ...
                {
                    Text =
                        "Only one visual editor can run at a time. External Render Queue processes are not affected.",
                    TextWrapping = TextWrapping.Wrap,
                    Opacity = 0.72,
                },
                close,
