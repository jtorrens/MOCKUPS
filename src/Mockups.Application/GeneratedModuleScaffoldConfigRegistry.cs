...
internal static class GeneratedModuleScaffoldConfigRegistry
{
        ...
        new(StringComparer.Ordinal)
    {
        ...
        ["module.core.videoCall.gridRows"] = new(
            ...
            "",
            []),
        ["module.core.videoCall.gridSurface"] = new(
            "module.core.videoCall",
            "module.core.videoCall.gridSurface",
            ValueKind.ComponentVariantSlot,
            ["videoCall", "gridSurfaceSlot"],
            "surface",
            []),
        ...
        ["module.core.videoCall.mainRows"] = new(
            ...
            "",
            []),
        ["module.core.videoCall.mainSurface"] = new(
            "module.core.videoCall",
            "module.core.videoCall.mainSurface",
            ValueKind.ComponentVariantSlot,
        ...
        ["module.core.videoCall.participantAvatar"] = new(
            ...
            ValueKind.ComponentVariantSlot,
            ["videoCall", "participantAvatarSlot"],
            "avatar",
            []),
        ["module.core.videoCall.participantAvatarSize"] = new(
            "module.core.videoCall",
            "module.core.videoCall.participantAvatarSize",
            ValueKind.Integer,
            ["videoCall", "participantAvatarSize"],
            "",
            []),
        ["module.core.videoCall.participantContentPadding"] = new(
            "module.core.videoCall",
            "module.core.videoCall.participantContentPadding",
            ValueKind.ThemeTokenPair,
        ...
        ["module.core.videoCall.pipSize"] = new(
            ...
            "",
            []),
        ["module.core.videoCall.pipSurface"] = new(
            "module.core.videoCall",
            "module.core.videoCall.pipSurface",
            ValueKind.ComponentVariantSlot,
            ["videoCall", "pipSurfaceSlot"],
            "surface",
            []),
        ["module.core.videoCall.showFallbackAvatar"] = new(
            "module.core.videoCall",
            "module.core.videoCall.showFallbackAvatar",
            ValueKind.Boolean,
            ["videoCall", "showFallbackAvatar"],
            "",
            []),
        ["module.core.videoCall.showFallbackStatus"] = new(
            "module.core.videoCall",
            "module.core.videoCall.showFallbackStatus",
            ValueKind.Boolean,
            ["videoCall", "showFallbackStatus"],
            "",
            []),
        ...
        ["module.core.videoCall.showNavigationBar"] = new(
            ...
            "",
            []),
        ["module.core.videoCall.showParticipantMedia"] = new(
            "module.core.videoCall",
            "module.core.videoCall.showParticipantMedia",
            ValueKind.Boolean,
            ["videoCall", "showParticipantMedia"],
            "",
            []),
        ["module.core.videoCall.showParticipantSurface"] = new(
            "module.core.videoCall",
            "module.core.videoCall.showParticipantSurface",
            ValueKind.Boolean,
            ["videoCall", "showParticipantSurface"],
            "",
            []),
