...
public static class ComponentPreviewActions
{
...
public sealed record ComponentPreviewActionDefinition(
    string Id,
    string Label,
    string PlayInputId,
...
public enum ComponentPreviewActionTargetMode
{
    None,
    Toggle,
    Option,
...
public enum ComponentPreviewActionTimeUnit
{
    Seconds,
    Frames,
    Milliseconds,
...
public enum ComponentPreviewActionCompletionBehavior
{
    Reset,
    HoldFinal,
}
