...
public static class RecordClassFieldCatalog
{
    ...
    private static readonly Dictionary<string, RecordClassFieldDescriptor> Fields = new(StringComparer.Ordinal)
    {
        ...
        ["palette.defaultValueHex"] = new("palette.defaultValueHex", "Default Hex", ValueKind.HexColor),
        ...
        ["productionPalette.valueHex"] = new("productionPalette.valueHex", "Hex", ValueKind.HexColor),
