...
public static partial class ComponentClassFieldCatalog
{
    ...
    private static readonly Dictionary<string, ComponentClassFieldDescriptor> Fields = new(StringComparer.Ordinal)
    {
        ...
        ["component.textBox.surface.editor"] = new("component.textBox.surface.editor", "Surface", ValueKind.ComponentVariant, ["textBox", "surfaceSlot", "variantReference"], "InputBox"),
        ...
        ["component.textBox.maxLines"] = new(
            "component.textBox.maxLines",
            "Max lines",
            ValueKind.Integer,
            ["textBox", "maxLines"],
            "4",
            Number: new NumberDefinition(1, 64, 1, 0)),
        ["component.textBox.iconGap"] = new(
            "component.textBox.iconGap",
            "Gap to text",
            ValueKind.ThemeToken,
            ["textBox", "iconGap"],
            "theme.spacing.m",
            Options: SpacingTokenOptions),
        ["component.textBox.leftIconRow.editor"] = new(
            "component.textBox.leftIconRow.editor",
            "Left icon row",
            ValueKind.ComponentVariant,
            ["textBox", "leftIconRowSlot", "variantReference"],
            "default"),
        ["component.textBox.rightIconRow.editor"] = new(
            "component.textBox.rightIconRow.editor",
            "Right icon row",
            ValueKind.ComponentVariant,
            ["textBox", "rightIconRowSlot", "variantReference"],
            "default"),
        ...
        ["component.textBox.cursor.editor"] = new("component.textBox.cursor.editor", "Cursor", ValueKind.ComponentVariant, ["textBox", "cursorSlot", "variantReference"], "default"),

        ["component.iconRow.items"] = new(
        ...
        ["component.iconBar.idleLeftIconRow.editor"] = new("component.iconBar.idleLeftIconRow.editor", "Idle left row", ValueKind.ComponentVariant, ["iconBar", "idleLeftIconRowSlot", "variantReference"], "default"),
        ...
        ["component.textInputBar.height"] = new("component.textInputBar.height", "Height", ValueKind.Integer, ["textInput", "height"], "44"),
        ["component.textInputBar.barPadding"] = new("component.textInputBar.barPadding", "Bar padding", ValueKind.ThemeTokenPair, ["textInput", "barPadding"], "theme.spacing.l|theme.spacing.m", PairLabels: new("X", "Y"), Options: SpacingTokenOptions),
        ["component.textInputBar.barSurface.editor"] = new("component.textInputBar.barSurface.editor", "Bar surface", ValueKind.ComponentVariant, ["textInput", "barSurfaceSlot", "variantReference"], "default"),
        ["component.textInputBar.iconGap"] = new("component.textInputBar.iconGap", "Icon gap", ValueKind.ThemeToken, ["textInput", "iconGap"], "theme.spacing.m", Options: SpacingTokenOptions),
        ["component.textInputBar.iconBar.editor"] = new("component.textInputBar.iconBar.editor", "Icon bar", ValueKind.ComponentVariant, ["textInput", "iconBarSlot", "variantReference"], "default"),
        ["component.textInputBar.textBox.editor"] = new("component.textInputBar.textBox.editor", "Text box variant", ValueKind.ComponentVariant, ["textInput", "textBoxSlot", "variantReference"], "default"),
        ["component.textInputBar.textBox.inputs"] = new(
            ...
            RuntimeInputComponentVariantFieldId: "component.textInputBar.textBox.editor"),
        ...
        ["component.keyboard.iconBar.editor"] = new("component.keyboard.iconBar.editor", "Icon bar", ValueKind.ComponentVariant, ["keyboard", "iconBarSlot", "variantReference"], "default"),
        ...
        ["component.keypad.label.editor"] = new("component.keypad.label.editor", "Label", ValueKind.ComponentVariant, ["keypad", "labelSlot", "variantReference"], "default"),
        ...
        ["component.codeIndicator.states.initial.empty.editor"] = new("component.codeIndicator.states.initial.empty.editor", "Empty", ValueKind.ComponentVariant, ["codeIndicator", "states", "initial", "emptySurfaceSlot", "variantReference"], "default"),
        ["component.codeIndicator.states.initial.filled.editor"] = new("component.codeIndicator.states.initial.filled.editor", "Filled", ValueKind.ComponentVariant, ["codeIndicator", "states", "initial", "filledSurfaceSlot", "variantReference"], "default"),
        ["component.codeIndicator.states.correct.empty.editor"] = new("component.codeIndicator.states.correct.empty.editor", "Empty", ValueKind.ComponentVariant, ["codeIndicator", "states", "correct", "emptySurfaceSlot", "variantReference"], "default"),
        ["component.codeIndicator.states.correct.filled.editor"] = new("component.codeIndicator.states.correct.filled.editor", "Filled", ValueKind.ComponentVariant, ["codeIndicator", "states", "correct", "filledSurfaceSlot", "variantReference"], "default"),
        ["component.codeIndicator.states.incorrect.empty.editor"] = new("component.codeIndicator.states.incorrect.empty.editor", "Empty", ValueKind.ComponentVariant, ["codeIndicator", "states", "incorrect", "emptySurfaceSlot", "variantReference"], "default"),
        ["component.codeIndicator.states.incorrect.filled.editor"] = new("component.codeIndicator.states.incorrect.filled.editor", "Filled", ValueKind.ComponentVariant, ["codeIndicator", "states", "incorrect", "filledSurfaceSlot", "variantReference"], "default"),
        ...
        ["component.password.initialLabel.editor"] = new("component.password.initialLabel.editor", "Initial label", ValueKind.ComponentVariant, ["password", "initialLabelSlot", "variantReference"], "default"),
        ["component.password.correctLabel.editor"] = new("component.password.correctLabel.editor", "Correct label", ValueKind.ComponentVariant, ["password", "correctLabelSlot", "variantReference"], "default"),
        ["component.password.incorrectLabel.editor"] = new("component.password.incorrectLabel.editor", "Incorrect label", ValueKind.ComponentVariant, ["password", "incorrectLabelSlot", "variantReference"], "default"),
        ["component.password.indicator.editor"] = new("component.password.indicator.editor", "Code indicator", ValueKind.ComponentVariant, ["password", "indicatorSlot", "variantReference"], "default"),
        ["component.password.keypad.editor"] = new("component.password.keypad.editor", "Keypad", ValueKind.ComponentVariant, ["password", "keypadSlot", "variantReference"], "default"),
        ["component.password.fingerprint.editor"] = new("component.password.fingerprint.editor", "Fingerprint", ValueKind.ComponentVariant, ["password", "fingerprintSlot", "variantReference"], "default"),
        ["component.password.faceRecognition.editor"] = new("component.password.faceRecognition.editor", "Face recognition", ValueKind.ComponentVariant, ["password", "faceRecognitionSlot", "variantReference"], "default"),
        ["component.password.drawPassword.editor"] = new("component.password.drawPassword.editor", "Draw password", ValueKind.ComponentVariant, ["password", "drawPasswordSlot", "variantReference"], "default"),
        ["component.password.iconBar.editor"] = new("component.password.iconBar.editor", "Icon bar", ValueKind.ComponentVariant, ["password", "iconBarSlot", "variantReference"], "default"),
        ...
        ["component.notification.avatar.editor"] = new("component.notification.avatar.editor", "Avatar", ValueKind.ComponentVariant, ["notification", "avatarSlot", "variantReference"], "default"),
        ...
        ["component.notification.summaryLabel.editor"] = new("component.notification.summaryLabel.editor", "Summary label", ValueKind.ComponentVariant, ["notification", "summaryLabelSlot", "variantReference"], "default"),
        ["component.notification.detailLabel.editor"] = new("component.notification.detailLabel.editor", "Detail label", ValueKind.ComponentVariant, ["notification", "detailLabelSlot", "variantReference"], "default"),
        ["component.notification.surface.editor"] = new("component.notification.surface.editor", "Surface", ValueKind.ComponentVariant, ["notification", "surfaceSlot", "variantReference"], "default"),
        ["component.notifications.collectionStack.editor"] = new("component.notifications.collectionStack.editor", "Collection Stack", ValueKind.ComponentVariant, ["notifications", "collectionStackSlot", "variantReference"], "default"),
        ["component.notifications.notification.editor"] = new("component.notifications.notification.editor", "Notification", ValueKind.ComponentVariant, ["notifications", "notificationSlot", "variantReference"], "default"),
        ...
        ["component.notifications.badge.editor"] = new("component.notifications.badge.editor", "Badge", ValueKind.ComponentVariant, ["notifications", "badgeSlot", "variantReference"], "default"),
        ...
        ["component.button.states.active.surface.editor"] = new("component.button.states.active.surface.editor", "Surface", ValueKind.ComponentVariant, ["button", "states", "active", "surfaceSlot", "variantReference"], "default"),
        ["component.button.states.active.label.editor"] = new("component.button.states.active.label.editor", "Label", ValueKind.ComponentVariant, ["button", "states", "active", "labelSlot", "variantReference"], "default"),
        ...
        ["component.button.states.pushed.surface.editor"] = new("component.button.states.pushed.surface.editor", "Surface", ValueKind.ComponentVariant, ["button", "states", "pushed", "surfaceSlot", "variantReference"], "default"),
        ["component.button.states.pushed.label.editor"] = new("component.button.states.pushed.label.editor", "Label", ValueKind.ComponentVariant, ["button", "states", "pushed", "labelSlot", "variantReference"], "default"),
        ...
        ["component.button.states.disabled.surface.editor"] = new("component.button.states.disabled.surface.editor", "Surface", ValueKind.ComponentVariant, ["button", "states", "disabled", "surfaceSlot", "variantReference"], "default"),
        ["component.button.states.disabled.label.editor"] = new("component.button.states.disabled.label.editor", "Label", ValueKind.ComponentVariant, ["button", "states", "disabled", "labelSlot", "variantReference"], "default"),
        ...
        ["component.label.surface.editor"] = new("component.label.surface.editor", "Surface", ValueKind.ComponentVariant, ["label", "surfaceSlot", "variantReference"], "Label"),
        ...
        ["component.audio.durationLabel.editor"] = new("component.audio.durationLabel.editor", "Duration label", ValueKind.ComponentVariant, ["audio", "durationLabelSlot", "variantReference"], "default"),
        ...
        ["component.status_bar.foregroundColorToken"] = new("component.status_bar.foregroundColorToken", "Foreground", ValueKind.ThemeToken, ["foregroundColorToken"], "theme.icons.primary", Options: ThemeColorOptions),
        ["component.status_bar.backgroundColorToken"] = new("component.status_bar.backgroundColorToken", "Background", ValueKind.ThemeToken, ["backgroundColorToken"], "theme.colors.background", Options: ThemeColorOptions),
        ["component.status_bar.backgroundAlpha"] = new("component.status_bar.backgroundAlpha", "Background alpha", ValueKind.Alpha, ["backgroundAlpha"], "1"),
        ["component.status_bar.layout.height"] = new("component.status_bar.layout.height", "Height", ValueKind.Integer, ["layout", "height"], "54"),
        ["component.status_bar.layout.itemSize"] = new("component.status_bar.layout.itemSize", "Item size", ValueKind.Integer, ["layout", "itemSize"], "18"),
        ["component.status_bar.layout.gap"] = new("component.status_bar.layout.gap", "Gap", ValueKind.ThemeToken, ["layout", "gap"], "theme.spacing.m", Options: SpacingTokenOptions),
        ["component.status_bar.layout.sidePadding"] = new("component.status_bar.layout.sidePadding", "Side padding", ValueKind.ThemeToken, ["layout", "sidePadding"], "theme.spacing.xxl", Options: SpacingTokenOptions),
        ["component.status_bar.items"] = new("component.status_bar.items", "Items", ValueKind.StructuredCollection, ["items"], "[]", StructuredCollection: StatusBarItemsCollection),

        ["component.navigation_bar.foregroundColorToken"] = new("component.navigation_bar.foregroundColorToken", "Foreground", ValueKind.ThemeToken, ["foregroundColorToken"], "theme.icons.primary", Options: ThemeColorOptions),
        ["component.navigation_bar.backgroundColorToken"] = new("component.navigation_bar.backgroundColorToken", "Background", ValueKind.ThemeToken, ["backgroundColorToken"], "theme.colors.background", Options: ThemeColorOptions),
        ["component.navigation_bar.backgroundAlpha"] = new("component.navigation_bar.backgroundAlpha", "Background alpha", ValueKind.Alpha, ["backgroundAlpha"], "1"),
        ["component.navigation_bar.type"] = new("component.navigation_bar.type", "Type", ValueKind.OptionToken, ["type"], "buttons", Options: NavigationBarTypeOptions),
        ["component.navigation_bar.layout.height"] = new("component.navigation_bar.layout.height", "Height", ValueKind.Integer, ["layout", "height"], "34"),
        ["component.navigation_bar.layout.itemSize"] = new("component.navigation_bar.layout.itemSize", "Item size", ValueKind.Integer, ["layout", "itemSize"], "18"),
        ["component.navigation_bar.layout.sidePadding"] = new("component.navigation_bar.layout.sidePadding", "Side padding", ValueKind.ThemeToken, ["layout", "sidePadding"], "theme.spacing.xxl", Options: SpacingTokenOptions),
        ["component.navigation_bar.layout.strokeWidth"] = new("component.navigation_bar.layout.strokeWidth", "Stroke width", ValueKind.Integer, ["layout", "strokeWidth"], "2"),
        ["component.navigation_bar.layout.cornerRadius"] = new("component.navigation_bar.layout.cornerRadius", "Corner radius", ValueKind.Integer, ["layout", "cornerRadius"], "3"),
        ["component.navigation_bar.layout.filled"] = new("component.navigation_bar.layout.filled", "Filled", ValueKind.Boolean, ["layout", "filled"], "false"),
        ["component.navigation_bar.gesture.width"] = new("component.navigation_bar.gesture.width", "Width", ValueKind.Integer, ["gesture", "width"], "134"),
        ["component.navigation_bar.gesture.height"] = new("component.navigation_bar.gesture.height", "Height", ValueKind.Integer, ["gesture", "height"], "5"),
        ["component.navigation_bar.gesture.cornerRadius"] = new("component.navigation_bar.gesture.cornerRadius", "Corner radius", ValueKind.Integer, ["gesture", "cornerRadius"], "999"),
        ["component.navigation_bar.items"] = new("component.navigation_bar.items", "Button Items", ValueKind.StructuredCollection, ["items"], "[]", StructuredCollection: NavigationBarItemsCollection),

        ["component.media.surface.editor"] = new("component.media.surface.editor", "Surface", ValueKind.ComponentVariant, ["media", "surfaceSlot", "variantReference"], "default"),
        ...
        ["component.media.inlineTopIconBar.editor"] = new("component.media.inlineTopIconBar.editor", "Top icon bar", ValueKind.ComponentVariant, ["media", "inlineTopIconBarSlot", "variantReference"], "default"),
        ["component.media.inlineCenterIconBar.editor"] = new("component.media.inlineCenterIconBar.editor", "Center icon bar", ValueKind.ComponentVariant, ["media", "inlineCenterIconBarSlot", "variantReference"], "default"),
        ["component.media.inlineBottomIconBar.editor"] = new("component.media.inlineBottomIconBar.editor", "Bottom icon bar", ValueKind.ComponentVariant, ["media", "inlineBottomIconBarSlot", "variantReference"], "default"),
        ["component.media.fullScreenTopIconBar.editor"] = new("component.media.fullScreenTopIconBar.editor", "Top icon bar", ValueKind.ComponentVariant, ["media", "fullScreenTopIconBarSlot", "variantReference"], "default"),
        ["component.media.fullScreenCenterIconBar.editor"] = new("component.media.fullScreenCenterIconBar.editor", "Center icon bar", ValueKind.ComponentVariant, ["media", "fullScreenCenterIconBarSlot", "variantReference"], "default"),
        ["component.media.fullScreenBottomIconBar.editor"] = new("component.media.fullScreenBottomIconBar.editor", "Bottom icon bar", ValueKind.ComponentVariant, ["media", "fullScreenBottomIconBarSlot", "variantReference"], "default"),
        ...
        ["component.media.idleText.label.editor"] = new("component.media.idleText.label.editor", "Label", ValueKind.ComponentVariant, ["media", "idleText", "labelSlot", "variantReference"], "default"),
        ...
        ["component.media.playText.label.editor"] = new("component.media.playText.label.editor", "Label", ValueKind.ComponentVariant, ["media", "playText", "labelSlot", "variantReference"], "default"),
        ...
        ["component.bubble.surface.editor"] = new("component.bubble.surface.editor", "Surface", ValueKind.ComponentVariant, ["bubble", "surfaceSlot", "variantReference"], "default"),
        ["component.bubble.textBox.editor"] = new("component.bubble.textBox.editor", "Text box", ValueKind.ComponentVariant, ["bubble", "textBoxSlot", "variantReference"], "default"),
        ...
        ["component.bubble.media.image.editor"] = new("component.bubble.media.image.editor", "Image variant", ValueKind.ComponentVariant, ["bubble", "imageMediaSlot", "variantReference"], "default"),
        ["component.bubble.media.video.editor"] = new("component.bubble.media.video.editor", "Video variant", ValueKind.ComponentVariant, ["bubble", "videoMediaSlot", "variantReference"], "default"),
        ["component.bubble.media.audio.editor"] = new("component.bubble.media.audio.editor", "Audio variant", ValueKind.ComponentVariant, ["bubble", "audioSlot", "variantReference"], "default"),
        ...
        ["component.bubble.actorLabel.editor"] = new("component.bubble.actorLabel.editor", "Actor label", ValueKind.ComponentVariant, ["bubble", "actorLabelSlot", "variantReference"], "default"),
        ...
        ["component.bubble.avatar.editor"] = new("component.bubble.avatar.editor", "Avatar", ValueKind.ComponentVariant, ["bubble", "avatarSlot", "variantReference"], "default"),
