...
public static class RuntimeInputValueKindContract
{
    ...
    private static void ValidateValuePattern(
        JsonObject definition,
        JsonNode value,
        string owner)
    {
        var pattern = definition["valuePattern"] is JsonValue patternNode
