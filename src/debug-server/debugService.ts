...
export const APP_TABLES = [
  ...
  },
  {
    ...
    fields: [
      ...
      { column: "component_type", label: "Component type", kind: "string", readonly: true },
      { column: "name", label: "Name", kind: "string" },
      { column: "tokens_json", label: "Component tokens", kind: "json" },
      { column: "metadata_json", label: "Component notes", kind: "json" },
    ],
  },
  {
    id: "themes",
...
const PARSERS = {
  ...
  component_classes: ComponentClassSchema,
  themes: ThemeSchema,
