...
public sealed record ThemeColorTokenPath(
    string Id,
...
public static class ThemeColorTokenCatalog
{
    ...
    [
        ...
        Token("theme.colors.positive", ["modes", "light", "colors", "positive"], ["modes", "dark", "colors", "positive"]),
        Token("theme.colors.negative", ["modes", "light", "colors", "negative"], ["modes", "dark", "colors", "negative"]),
        Token("theme.colors.onAction", ["modes", "light", "colors", "onAction"], ["modes", "dark", "colors", "onAction"]),
