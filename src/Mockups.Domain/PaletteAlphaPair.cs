...
public sealed record PaletteAlphaValue(string ColorToken, double Alpha);

public sealed record PaletteAlphaPair(PaletteAlphaValue First, PaletteAlphaValue Second)
{
